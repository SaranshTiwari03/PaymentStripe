...
import "../StyleComponents/cartstyle.css"
...
const CartDetails = () => {
    ...
    const makePayment = async()=>{
        const stripe = await loadStripe("pk_test_51PF8QbSJNbdTbIz7w48nHcpQfQLZZbRfKIADL3EGg3vRV2UMjGr48OSjbbtnjZTYIPbJXoUfoA1SKiOsIuYBs00g00qd2wkx3Z");
                                                    ...
                                                    return (
                                                        <>
                                                            <tr>
                                                                ...
                                                                <td><div className='product-name'><p>{data.product}</p></div></td>
                                                                <td>{data.price}</td>
                                                                <td>
